...
<script type="text/javascript">
                ...
                //拼接ID
                    ...
                    $.ajax({
                        ...
                        success:function (msg){
                            alert(msg);
                            $("#table").load("http://localhost:8080/mimi_war_exploded/admin/product.jsp #table");
                        }
                    })
                    //发送请求到服务器端
    ...
    function del(pid,ispage) {
        if (confirm("确定删除吗")) {
            ...
            $.ajax({
                ...
                data:{"pid":pid,"page":ispage,"pname":pname,"typeId":typeid,"lowPrice":lprice,"highPrice":hprice},
                type: "post",
                dataType:"text",
                success:function (msg){
                    alert(msg);
    ...
    function one(pid, ispage) {
        ...
        var str = "?pid="+pid+"&page="+ispage+"&pname="+pname+"&typeId="+typeid+"&lowPrice="+lprice+"&highPrice="+hprice
        //向服务器提交请求，传递商品id
...
<script type="text/javascript">
    function ajaxsplit(page) {
        ...
        url:"${pageContext.request.contextPath}/prod/ajaxsplit.action",
            data:{"page":page,"pname":pname,"typeId":typeid,"lowPrice":lprice,"highPrice":hprice},
            type:"post",
            success:function () {
                //重新加载分页显示的组件table
    ...
    function condition(){
        ...
        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/prod/ajaxsplit.action",
            data:{"pname":pname,"typeId":typeid,"lowPrice":lprice,"highPrice":hprice},
            success:function (){
